 ...
 */
Complex.add= function(complex){
    let real= this.r +complex.r;
    let imagiary= this.i +complex.i;
    return Complex(real, imagiary);
};
Complex.multiply=function(complex){
    let real= this.r * complex.r - this.i* complex.i;
    let imagiary= this.r * complex.i+ this.i * complex.r;
    return Complex(real, imagiary);
};
Complex.realMagnitude= function(){
return Math.sqrt(Math.pow(this.i,2) + Math.pow(this.r,2));
};
Complex.neg= function(){
return Complex(-this.r,-this.i);
};
Complex.toString= function(){
    return  this.r.toString() + ' ' + this.i.toString() + 'i';
};
Complex.equals= function(complex){
...
console.log(Complex.parse(c.toString()).            // Convert c to a string and back again,
